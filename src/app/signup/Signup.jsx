      ...
      <div className="2xl:container m-auto">
        <div className="grid md:grid-cols-2 items-center">
          ...
          <div className="flex flex-col justify-center items-center mb-20">
            <h1 className="font-48 font-bold leading-[60px]"> Sign Up </h1>
            <div className="mt-16 flex flex-col gap-8">
              <div class="relative float-label-input">
                <input
                  type="email"
                  placeholder="Enter Name"
                  class="block m-auto sm:w-[350px] lg:w-[414px] text-black font-16 semifont-bold bg-transparent focus:outline-none focus:shadow-outline border border-[#000] rounded-lg py-3 px-3 leading-normal"
            ...
            <div className="flex flex-col gap-8 mt-8">
              ...
              <div className="m-auto sm:m-1">
                <Link href="/Onboarding" className="secondary-blue-btn font-20">
                  Sign Up
                </Link>
              </div>
