import { current } from '@/app/data/current';
          ...
          >
            ...
            <div className="flex flex-col gap-4 mt-3 md:mt-0">
              ...
              <div className="flex md:justify-end items-end">
                <h1 className="ongoing-badge">{item.status}</h1>
              </div>

              <Link href="/current-detail" className="check-detail-btn flex md:justify-end items-end">
                {item.detailBtn}
              </Link>
            </div>
          </div>
