...
const Pending = () => {
  return (
    <div>
      <div className="font-20 bold-font leading-6">Order Detail</div>

      <div className="flex justify-between items-center mt-7">
        <div className="font-16 medium-font leading-5">Charlie Chaplin</div>
      ...
      <div className="sm:flex justify-between items-center mt-3 border-b border-[#C5C5C5] pb-7 space-y-5 sm:space-y-0">
        <div className="font-22 regular-font leading-normal text-[#5F5F5F]">
          Order Id: 1326747
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 mt-7">
        <div className="flex justify-between items-center">
          <div className="font-20 bold-font leading-6 text-[#3F3F3F]">
            Heater Repairing
          </div>
          <div>
        ...
        <div>
          <div className="flex gap-2">
            <Image
              ...
              alt="location"
            />
            <span className="font-14 regular-font leading-normal">
              Location
            </span>
          </div>
        </div>
        ...
        <div>
          <p className="font-16 regular-font leading-5 opacity-60">
      ...
      <div className="grid sm:grid-cols-2 gap-6 mt-7">
        <div className="bg-[#FFFFFF] rounded-lg py-5 px-4 gap-4 border border-[#C5C5C5] flex flex-col justify-center items-center">
          ...
          <h1 className="font-14 regular-font leading-normal text-[#3F3F3F]">
            19 Jan 2023
          </h1>
        </div>
        <div className="bg-[#FFFFFF] rounded-lg py-5 px-4 gap-4 border border-[#C5C5C5] flex flex-col justify-center items-center">
      ...
      <div className="my-5">
        <div>
          ...
          <p className="font-16 regular-font leading-5 opacity-60  pt-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud <br className="hidden md:block" />
            exercitation ullamco laboris nisi ut aliquip ex ea commodo
